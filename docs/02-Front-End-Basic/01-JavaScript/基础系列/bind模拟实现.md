...
关于指定 this 的指向，我们可以使用 call 或者 apply 实现，关于 call 和 apply 的模拟实现，可以查看[《 call 和 apply 的模拟实现》]。我们来写第一版的代码：
...
当然最好是用 [es5-shim](https://hub.fastgit.org/es-shims/es5-shim) 啦。
