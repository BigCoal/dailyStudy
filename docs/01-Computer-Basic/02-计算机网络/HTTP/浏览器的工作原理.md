...
![](./static/image011.png) 图：从源文档到解析树
...
![](./static/image015.png) 图：示例标记的 DOM 树
...
![](./static/image017.png) 图：HTML 解析流程（摘自 HTML5 规范）
...
![](./static/image025.png) 图：呈现树及其对应的 DOM 树 ([3.1](#3_1))。初始容器 block 为 “viewport”，而在 WebKit 中则为“RenderView” 对象。
...
![](./static/image035.png) 图：Firefox 样式上下文树 ([2.2](#2_2))
...
![](./static/reflow.png) 图：增量布局 - 只有 dirty 呈现器及其子代进行布局 ([3.6](#3_6))。
...
![](./static/image046.jpg) 图：CSS2 框模型
